...
SECRET_KEY = '4kh%l4ppg&58!o5_i1sr#*^z2&gwt3*8h05dzb&=p*@l!_n=td'
...
TINYMCE_DEFAULT_CONFIG = {
    ...
    'toolbar1':
    'save fullscreen bold italic underline,fontselect,fontsizeselect  | forecolor backcolor | alignleft aligncenter alignright alignjustify'
